              ...
              <Table.Tbody>
                ...
                <Table.Tr className="">
                  ...
                  <Table.Td className="!pt-6 border-transparent dark:!border-transparent text-left w-32 text-[12px] whitespace-wrap text-base  font-medium ">
                    {billData?.originalAmount.toLocaleString()} BDT
                  </Table.Td>
                </Table.Tr>
                ...
                <Table.Tr className="">
                  ...
                  <Table.Td className="!pt-6 border-transparent dark:!border-transparent text-left w-32 text-[12px] whitespace-wrap text-base  font-medium ">
                    {billData?.netTotal.toLocaleString()} BDT
                  </Table.Td>
                </Table.Tr>
                ...
                <Table.Tr className="py-0">
                  ...
                  <Table.Td className=" border-transparent text-left w-36 text-base  font-medium whitespace-wrap">
                    {billData?.paidAmount.toLocaleString()} BDT
                  </Table.Td>
                </Table.Tr>
                <Table.Tr className="py-0">
                  <Table.Td
                  ...
                  <Table.Td className=" border-transparent text-left w-36 text-base  font-medium whitespace-wrap">
                    {billData?.dueAmount.toLocaleString()} BDT
                  </Table.Td>
                </Table.Tr>
              </Table.Tbody>
            </Table>
